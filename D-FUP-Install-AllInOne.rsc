...
# All-in-one installer. Embeds D-FUP-Processor as /system script.
...
/system script add name="D-FUP-Processor" policy=read,write,test source="# D-FUP RouterOS 7 v1.1
...
:if ((\$dfupLastDownLevel != \$downLevel) || (\$dfupLastUpLevel != \$upLevel)) do={
    ...
    :log warning (\"D-FUP: level changed, down=\" . \$downLevel . \" (\" . \$downLoadPercent . \"%), up=\" . \$upLevel . \" (\" . \$upLoadPercent . \"%)\");
    ...
    :if (\$dfupCfgDebug = true) do={
        ...
        :log info (\"D-FUP: rx=\" . \$rxBps . \"bps avg=\" . \$dfupAvgRxBps . \"bps \" . \$downLoadPercent . \"%, tx=\" . \$txBps . \"bps avg=\" . \$dfupAvgTxBps . \"bps \" . \$upLoadPercent . \"%\");
